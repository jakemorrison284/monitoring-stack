...
- **Expected Behavior**: Triggers when the payment error rate exceeds **0.001%** for a sustained period of **5 minutes**.
...
- **Expected Behavior**: Triggers when more than **3 duplicates** are detected within a **5-minute** window.
